...
def main():
    ...
    if not check_passed:
        ...
        message = f"\nTo ensure that you get credit for your contribution to PlasmaPy, please add yourself as an author to CITATION.cff at https://github.com/{REPO}/edit/{branch_name}/CITATION.cff. The entry should be of the form:\n\n- given-names: <add given names>\n  family-names: <family names>\n  affiliation: <affiliation>\n  orcid: https://orcid.org/<ORCiD number>\n  alias: <GitHub-username>\n\nAll fields except `alias` are optional.\n\nSign up for ORCiD: https://orcid.org/register"
        print(message)
        sys.exit(1)
